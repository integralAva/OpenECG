...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOD, L4_Pin|LR_Pin|LG_Pin|LB_Pin
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOC, TWR_Pin|TCS_Pin);

  /**/
  LL_GPIO_SetOutputPin(GPIOB, TSDI_Pin|TRS_Pin|TRD_Pin|ADC_CS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = ECB_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ECB_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LL_GPIO_PIN_3|LL_GPIO_PIN_6|LL_GPIO_PIN_8
  ...
  /**/
  GPIO_InitStruct.Pin = TWR_Pin|TCS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_MEDIUM;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = TSDI_Pin|TRS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_MEDIUM;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = TRD_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(TRD_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_10|LL_GPIO_PIN_13|LL_GPIO_PIN_15;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = PWGD_Pin|ADC_DR_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = L4_Pin|LR_Pin|LG_Pin|LB_Pin
                          |L1_Pin|L2_Pin|L3_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_9|LL_GPIO_PIN_10|LL_GPIO_PIN_11|LL_GPIO_PIN_14
  ...
  /**/
  LL_GPIO_SetPinPull(ECA_GPIO_Port, ECA_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(ECS_GPIO_Port, ECS_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(PWCH_GPIO_Port, PWCH_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinPull(KFA_GPIO_Port, KFA_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(KFB_GPIO_Port, KFB_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(ECA_GPIO_Port, ECA_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ECS_GPIO_Port, ECS_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(PWCH_GPIO_Port, PWCH_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(KFA_GPIO_Port, KFA_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(KFB_GPIO_Port, KFB_Pin, LL_GPIO_MODE_INPUT);
